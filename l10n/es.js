OC.L10N.register(
    ...
    "The contact does not exists on the server anymore." : "Este contacto ya no existe en el servidor.",
    ...
    "You currently have no access to the memberlist" : "Actualmente no tiene acceso a la lista de miembros",
