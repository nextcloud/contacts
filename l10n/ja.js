OC.L10N.register(
    ...
    "_Imported %n contact_::_Imported %n contacts_" : ["%n件の連絡先をインポートしました"],
    "_(skipped %n contact)_::_(skipped %n contacts)_" : ["(%n件の連絡先をスキップしました)"],
    "Contacts" : "連絡先",
    ...
    "_Delete {number} contact_::_Delete {number} contacts_" : ["{number}の連絡先を削除する"],
    ...
    "_Add {number} contact to group_::_Add {number} contacts to group_" : ["{number}の連絡先をグループに追加する"],
    "Please select at least one editable contact to add to a group" : "グループに追加する編集可能な連絡先を少なくとも1つ選択してください",
    "_Move {number} contact to addressbook_::_Move {number} contacts to addressbook_" : ["{number}の連絡先をアドレス帳に移動する"],
