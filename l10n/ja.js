OC.L10N.register(
    ...
    "Address book {addressbook} not found" : "アドレス帳 {addressbook} が見つかりません",
    ...
    "Enforce password protection on files shared to this team" : "このチームと共有するファイルにパスワード保護を強制する",
    "Use a unique password for all shares to this team" : "このチームのすべての共有に一意のパスワードを使用する",
    ...
    "You are not a member of {circle}" : "あなたは {circle} のメンバーではありません",
    ...
    "Owner" : "所有者",
    "Invites" : "招待",
    "Anyone can request membership" : "誰でもメンバーへの参加をリクエストできる",
    "Members need to accept invitation" : "参加者は自身で招待を承認する必要がある",
    "Memberships must be confirmed/accepted by a Moderator (requires \"Anyone can request membership\")" : "メンバーへの参加はモデレーターによって確認と承認される必要がある(「誰でもメンバーへの参加をリクエストできる」が併せて必要)",
    "Members can also invite" : "メンバーによる参加者の招待を許可する",
    "Membership" : "メンバー",
    "Prevent teams from being a member of another team" : "チームが別のチームのメンバーになることを禁止する",
    "Privacy" : "プライバシー",
    "Visible to everyone" : "すべての人に公開する",
    "users" : "ユーザー",
    "Users" : "ユーザー",
    "groups" : "グループ",
    "teams" : "チーム",
