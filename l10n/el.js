OC.L10N.register(
    ...
    "Deleting the contact in {countdown} seconds" : "Η επαφή θα διαγραφεί σε {countdown} δευτερόλεπτα",
    "Done importing {total} contacts into" : "Η εισαγωγή {total} επαφών ολοκληρώθηκε",
    "Importing {total} contacts into" : "Εισαγωγή {total} επαφών",
    ...
    "Enabled toggle of addressbook was not successful." : "Απέτυχε η εναλλαγή του βιβλίο διευθύνσεων",
    ...
    "The date of marriage, or equivalent, of this contact" : "Ημερομηνία γάμου, ή αντίστοιχη",
    ...
    "The url of the profile. e.g. https://www.facebook.com/Nextclouders/ " : "Το URL της απαφής. π.χ. https://www.facebook.com/Nextclouders/ ",
    "Relationship" : "Σχέση",
    ...
    "Assistant" : "Βοηθός",
    "Related" : "Συγγένια",
    "Specify a relationship between another entity and the entity represented by this vCard." : "Καθορίστε μια σχέση μεταξύ μιας άλλης οντότητας και της οντότητας από αυτήν την vCard.",
    "Contact" : "Επαφή",
    "Agent" : "Συνεργάτης",
    "Emergency" : "Επείγον",
