OC.L10N.register(
    ...
    "Circles allow you to create groups with other users on a Nextcloud instance and share with them." : "Οι κύκλοι σας επιτρέπουν να δημιουργείτε ομάδες με άλλους χρήστες σε μια εγκατάσταση Nextcloud και να μοιράζεστε μαζί τους.",
    "Circle" : "Κύκλος",
    "User" : "Χρήστης",
    "Group" : "Ομάδα",
