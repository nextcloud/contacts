OC.L10N.register(
    ...
    "Email address is required." : "Eine E-Mail-Adresse ist erforderlich.",
    "An open invite already exists." : "Eine offene Einladung existiert bereits.",
    "Could not accept invite because no authenticated user was found." : "Die Einladung konnte nicht angenommen werden, da kein authentifizierter Benutzer gefunden wurde.",
    "The invite provider is invalid or not allowed." : "Der Einladungsanbieter ist ungültig oder unzulässig.",
    "Unable to accept this invitation. You are trying to accept an outgoing invitation." : "Diese Einladung kann nicht angenommen werden. Sie versuchen, eine ausgehende Einladung anzunehmen.",
    "Could not accept invite because the remote provider returned an invalid response." : "Die Einladung konnte nicht angenommen werden, da der Remote-Anbieter eine ungültige Antwort zurückgegeben hat.",
    "The remote provider accepted the invite, but this server could not create the local contact." : "Der Remote-Anbieter nahm die Einladung an, dieser Server konnte jedoch keinen lokalen Kontakt erstellen.",
    "Cannot resend: no email address" : "Kann nicht erneut gesendet werden: keine E-Mail-Adresse",
    "Invite has already been accepted." : "Einladung wurde bereits angenommen.",
    "Invite has expired. Please create a new one." : "Einladung ist abgelaufen. Bitte erstellen Sie eine neue.",
    "This is a copy of an invite sent to you previously by %1$s on %2$s" : "Dies ist eine Kopie einer Einladung, die Ihnen zuvor von %1$s am %2$s zugesandt wurde",
    "Invite already has an email address." : "Einladung verfügt bereits über eine E-Mail-Adresse",
    "An open invite for this email already exists." : "Für diese E-Mail-Adresse existiert bereits eine offene Einladung.",
    "Could not claim invite for this email; please refresh and try again." : "Die Einladung für diese E-Mail-Adresse konnte nicht beantwortet werden; bitte die Seite aktualisieren und erneut versuchen.",
    "Could not revert invite after delivery failure. Please refresh and try again." : "Die Einladung konnte nach dem Zustellungsfehler nicht zurückgesetzt werden. Bitte die Seite aktualisieren und erneut versuchen.",
    "OCM invites are disabled." : "OCM-Einladungen sind deaktiviert.",
    "Recipient email address is invalid." : "Die E-Mail-Adresse des Empfängers ist ungültig.",
    "%1$s via %2$s" : "%1$s über %2$s",
    "%1$s invites you to exchange contact information." : "%1$s lädt Sie zum Austausch von Kontaktdaten ein.",
    "This is a copy of the invitation you've sent to %1$s" : "Dies ist eine Kopie der Einladung, die Sie an %1$s gesendet haben",
    "Hi there," : "Hallo,",
    "%1$s invites you to exchange cloud accounts and contact information." : "%1$s lädt Sie zum Austausch von Cloud-Konten und Kontaktinformationen ein.",
    "This will allow you to share data with each other." : "Dies ermöglicht es Ihnen, Daten untereinander auszutauschen.",
    "To accept this invite, click the link below and sign in with your cloud provider:" : "Um diese Einladung anzunehmen, auf den unten stehenden Link klicken und melden Sie sich mit Ihrem Cloud-Anbieter an:",
    "Invitation details:" : "Einladungsdetails:",
    "Invite code: %1$s" : "Einladungs-Code: %1$s",
    "Encoded invite: %1$s" : "Verschlüsselte Einladung: %1$s",
    "To accept this invite, use the url below to sign in with your cloud provider:" : "Um diese Einladung anzunehmen, bitte die unten stehende URL verwenden, um sich bei Ihrem Cloud-Anbieter anzumelden:",
    "_Imported %n contact_::_Imported %n contacts_" : ["%n Kontakt importiert","%n Kontakte importiert"],
    "_(skipped %n contact)_::_(skipped %n contacts)_" : ["(%n Kontakt übersprungen)","(%n Kontakte übersprungen)"],
    "Contacts" : "Kontakte",
    ...
    "Could not save the setting" : "Die Einstellung konnte nicht gespeichert werden",
    "Allow updating avatars from social media" : "Die Aktualisierung von Avataren aus sozialen Medien erlauben",
    "External invitations" : "Externe Einladungen",
    "Allow creating invites without an email address (link-only)" : "Erstellen von Einladungen ohne E-Mail-Adresse (nur Link) zulassen",
    "Show the \"Copy encoded invite\" button on invite details" : "Die Schaltfläche “Verschlüsselte Einladung kopieren“ in den Einladungsdetails anzeigen",
    ...
    "Loading invitations…" : "Lade Einladungen …",
    "Could not load invitations" : "Einladungen konnten nicht geladen werden",
    "Retry" : "Wiederholen",
    "There are no invitations" : "Es gibt keine Einladungen",
    "Create invitation" : "Erstelle Einladung",
    "Loading …" : "Lade …",
    ...
    "Tried to drop an invalid contact!" : "Es wurde versucht, einen ungültigen Kontakt zu löschen!",
    "Rename" : "Umbenennen",
    "Export" : "Exportieren",
    "Send email" : "E-Mail senden",
    "Send email as BCC" : "E-Mail als BCC senden",
    "Delete" : "Löschen",
    ...
    "{addressbookname} (Hidden)" : "{addressbookname} (versteckt)",
    ...
    "Add new address book" : "Neues Adressbuch hinzufügen",
    "Cancel" : "Abbrechen",
    "Add" : "Hinzufügen",
    "First name" : "Vorname",
    "Last name" : "Nachname",
    ...
    "Sort contacts by" : "Kontakte sortieren nach",
    "Manages" : "Verwaltet",
    "Oversees" : "Überschaut",
    ...
    "This will create a regular folder shared with the team. To create a Team Folder, please contact your {productName} administrator" : "Dadurch wird ein regulärer Ordner erstellt, der mit dem Team geteilt wird. Um einen Team-Ordner zu erstellen, bitte die {productName}-Administration kontaktieren",
    ...
    "Unknown resource type" : "Unbekannter Ressourcentyp",
    "Team calendar \"{resourceName}\" created and shared with team" : "Der Team-Kalender \"{resourceName}\" wurde erstellt und mit dem Team geteilt",
    "{resourceType} \"{resourceName}\" created and shared with team" : "{resourceType} \"{resourceName}\" erstellt und mit dem Team geteilt",
    "A calendar named \"{name}\" already exists. Please choose a different name." : "Ein Kalender mit dem Namen \"{name}\" existiert bereits. Bitte einen anderen Namen wählen.",
    "Failed to create {resourceType}: {error}" : "{resourceType} konnte nicht erstellt werden: {error} ",
    ...
    "An error happened while saving {fields}" : "Beim Speichern von {fields} ist ein Fehler aufgetreten",
    "Team name" : "Teamname",
    "Team owner" : "Team-Besitzer",
    "Upload team picture" : "Teambild hochladen",
    "Choose from Nextcloud Files" : "Aus Nextcloud Dateien wählen",
    "Delete picture" : "Bild löschen",
    "Edit" : "Bearbeiten",
    "Request to join" : "Beitritt anfragen",
    "Create" : "Erstellen",
    "Show in Calendar" : "Im Kalender anzeigen",
    "Your request to join this team is pending approval" : "Ihre Anfrage, diesem Team beizutreten, muss noch genehmigt werden",
    "You are not a member of {circle}" : "Sie sind kein Mitglied von {circle}",
    "Members" : "Mitglieder",
    "Edit team picture" : "Teambild bearbeiten",
    "Apply" : "Anwenden",
    "Confirm" : "Bestätigen",
    "No other contacts available to select as line manager" : "Es stehen keine weiteren Kontakte zur Auswahl als Vorgesetzter.",
    "Add more info" : "Weitere Informationen hinzufügen",
    "More fields" : "Weitere Felder",
    "Please select a valid format" : "Bitte ein gültiges Format wählen",
    "Invalid image" : "Ungültiges Bild",
    "Error cropping picture" : "Fehler beim Zuschneiden des Bildes",
    ...
    "Add contacts to groups" : "Kontakte zu Gruppen hinzufügen",
    "Move contacts to addressbook" : "Kontakte in ein Adressbuch verschieben",
    ...
    "Move" : "Verschieben",
    "Unselect {name}" : "{name} abwählen",
    "Select {name}" : "{name} auswählen",
    "Could not update favorite status" : "Favoritenstatus konnte nicht aktualisiert werden",
    "from {addressbook}" : "aus {addressbook}",
    "Remove from favorites" : "Aus Favoriten entfernen",
    "Add to favorites" : "Zu den Favoriten hinzufügen",
    "Confirm merging contacts" : "Zusammenführen der Kontakte bestätigen",
    "The selected contacts have conflicting information. Choose which information to keep" : "Die ausgewählten Kontakte enthalten widersprüchliche Informationen. Bitte auswählen, welche Informationen behalten werden sollen",
    "Contacts can be merged" : "Kontakte können zusammengeführt werden",
    "Groups" : "Gruppen",
    "Select groups to add the merged contact to" : "Gruppen auswählen, denen die zusammengeführten Kontakte hinzugefügt werden sollen",
    "Merge contacts" : "Kontakte zusammenführen",
    "_Delete {number} contact_::_Delete {number} contacts_" : ["{number} Kontakt löschen","{number} Kontakte löschen"],
    "Please select at least one editable contact to delete" : "Bitte mindestens einen bearbeitbaren Kontakt zum Löschen auswählen",
    "Please select two editable contacts to merge" : "Bitte zwei bearbeitbare Kontakte zum Zusammenführen auswählen",
    "_Add {number} contact to group_::_Add {number} contacts to group_" : ["{number} Kontakt einer Gruppe hinzufügen","{number} Kontakte einer Gruppe hinzufügen"],
    "Please select at least one editable contact to add to a group" : "Bitte mindestens einen bearbeitbaren Kontakt zum Hinzufügen zu einer Gruppe auswählen",
    "_Move {number} contact to addressbook_::_Move {number} contacts to addressbook_" : ["{number} Kontakt in ein Adressbuch verschieben","{number} Kontakte in ein Adressbuch verschieben"],
    "Please select at least one editable contact to move to an addressbook" : "Bitte mindestens einen bearbeitbaren Kontakt zum Verschieben in ein Adressbuch auswählen",
    "Are you sure you want to proceed?" : "Möchten Sie fortfahren?",
    "Add contacts to group" : "Kontakte einer Gruppe hinzufügen",
    ...
    "This team will only be visible to you. Other members will not be able to see or use it." : "Dieses Team ist nur für Sie sichtbar. Andere Mitglieder können es nicht sehen oder verwenden.",
    ...
    "Accept membership request" : "Mitgliedsanfrage angenommen",
    ...
    "Add to {team}" : "Zu {team} hinzufügen",
    "Invite members to {team}" : "Mitglieder zu {team} einladen",
    "Pending" : "Ausstehend",
    "This invite does not look valid. Check that you copied it completely or ask the sender to generate a new one." : "Diese Einladung scheint ungültig zu sein. Überprüfen Sie, ob Sie sie vollständig kopiert haben, oder bitten Sie den Absender, eine neue zu erstellen.",
    "Accept invitation" : "Einladung annehmen",
    "Accepting will add the inviter to your contacts list and in return, your contact info will be sent to the inviter. From there on you can start sharing data with each other." : "Wenn Sie die Einladung annehmen, wird der Einladende Ihrer Kontaktliste hinzugefügt und im Gegenzug werden Ihre Kontaktdaten an ihn gesendet. Anschließend können Sie Daten miteinander austauschen.",
    "Invite link or code (required)" : "Einladungslink oder -code (erforderlich)",
    "Paste the invite link, or an invite code (token@provider), you received from the other person." : "Fügen Sie den Einladungslink oder den Einladungscode (token@provider) ein, den Sie von der anderen Person erhalten haben.",
    "Accept" : "Annehmen",
    "Please enter an email address." : "Bitte geben Sie eine E-Mail-Adresse ein.",
    "The recipient will receive an email with the invite link. Their email address will be saved on the invite so you can resend later." : "Der Empfänger erhält eine E-Mail mit dem Einladungslink. Seine E-Mail-Adresse wird in der Einladung gespeichert, sodass Sie sie später erneut senden können.",
    "Recipient email (required)" : "Empfänger E-Mailadresse (Erforderlich)",
    "email@example.com" : "email@beispiel.de",
    "Personal message (optional)" : "Persönliche Nachricht (Optional)",
    "Message to include in the email" : "Nachricht, die in der E-Mail enthalten sein soll",
    "Sending…" : "Sende …",
    "Send" : "Senden",
    "Invite code" : "Einladungs-Code",
    "Cloud provider" : "Cloud-Anbieter",
    "Encoded invite copied to clipboard" : "Die verschlüsselte Einladung wurde in die Zwischenablage kopiert.",
    "Invite code copied to clipboard" : "Einladungscode in die Zwischenablage kopiert",
    "Invite link copied to clipboard" : "Einladungslink in die Zwischenablage kopiert",
    "Copied to clipboard" : "In die Zwischenablage kopiert",
    "Failed to copy to clipboard" : "Fehler beim Kopieren in die Zwischenablage",
    "Could not resend invite" : "Einladung konnte nicht erneut gesendet werden",
    "Invite revoked" : "Einladung widerrufen",
    "Could not revoke invite" : "Einladung konnte nicht widerrufen werden",
    "Invite sent to {email}" : "Einladung gesendet an {email}",
    "Could not send invite" : "Einladung konnte nicht gesendet werden",
    "No invitation selected" : "Keine Einladung ausgewählt",
    "Select an invitation on the list to begin" : "Eine Einladung aus der Liste auswählen, um zu beginnen",
    "External invitation" : "Externe Einladung",
    "Label" : "Beschriftung",
    "Sent to" : "Senden an",
    "Created" : "Erstellt",
    "Expires" : "Ablaufdatum",
    "More ways to share" : "Weitere Möglichkeiten zum Teilen",
    "Useful for sharing through a chat app or for manual acceptance." : "Nützlich zum Teilen über eine Chat-App oder zur manuellen Bestätigung.",
    "Revoke invitation" : "Einladung zurückziehen",
    "Resend email" : "E-Mail erneut senden",
    "Send via email" : "Per E-Mail senden",
    "Send invitation via email" : "Einladung per E-Mail senden",
    "{name} invites you to exchange cloud accounts and contact information." : "{name} lädt Sie zum Austausch von Cloud-Konten und Kontaktinformationen ein.",
    "The invite link and code are added automatically when you send the invitation." : "Der Einladungslink und der Code werden beim Versenden der Einladung automatisch hinzugefügt.",
    "Recipient email" : "Empfänger E-Mailadresse",
    "Invite someone outside your organization to collaborate" : "Laden Sie jemanden außerhalb Ihrer Organisation zur Zusammenarbeit ein.",
    "After the invitee accepts the invite, both of you will appear in each other's contacts list and you can start sharing data with each other." : "Nachdem der Eingeladene die Einladung angenommen hat, erscheinen Sie beide in der Kontaktliste des jeweils anderen und können mit dem Datenaustausch beginnen.",
    "Send invite via email" : "Einladung per E-Mail senden",
    "Hide email preview" : "E-Mailvorschau verbergen",
    "Show email preview" : "E-Mailvorschau anzeigen",
    "This is what {recipient} will receive:" : "Dies ist was {recipient} empfangen wird:",
    "If you do not send an email, you will need to share the invite link yourself." : "Wenn Sie keine E-Mail senden, müssen Sie den Einladungslink selbst weitergeben.",
    "Invite link" : "Einladungs-Link",
    "Copy invite link to clipboard" : "Einladungslink in die Zwischenablage kopieren",
    "Copy invite code to clipboard" : "Einladungscode in die Zwischenablage kopieren",
    "Encoded invite" : "Verschlüsselte Einladung",
    "Copy encoded invite to clipboard" : "Die verschlüsselte Einladung in die Zwischenablage kopieren",
    "Search invites…" : "Einladungen suchen …",
    "Could not discover that provider. Check the address and try again." : "Der Anbieter konnte nicht gefunden werden. Bitte die Adresse überprüfen und erneut versuchen.",
    "Select your server" : "Server auswählen",
    "Type to search" : "Zum Suchen etwas eingeben",
    "No servers match your search." : "Es wurden keine Server gefunden, die Ihrer Suche entsprechen.",
    "No servers are currently available." : "Es sind derzeit keine Server verfügbar.",
    "Your server not listed? Enter one manually." : "Ihr Server ist nicht aufgeführt? Geben Sie ihn manuell ein.",
    "Continue" : "Fortsetzen",
    "You need an invite link for this feature to work." : "Für diese Funktion benötigen Sie einen Einladungslink.",
    ...
    "JavaScript URIs are not allowed" : "JavaScript URIs sind unzulässig",
    "Notes" : "Notizen",
    ...
    "Member" : "Mitglied",
    "This is a read-only group managed by administrators. Group members can only view this group." : "Dies ist eine schreibgeschützte Gruppe, die von der Administration verwaltet wird. Gruppenmitglieder können diese Gruppe nur ansehen.",
    "Send invitation" : "Einladung senden",
    "Generate invitation" : "Erstelle Einladung",
    "This invite link is incomplete. Ask the sender to generate a new one." : "Dieser Einladungslink ist unvollständig. Bitten Sie den Absender, einen neuen zu generieren.",
    "Unable to create the contact." : "Kontakt konnte nicht erstellt werden.",
    "Contact not found" : "Kontakt nicht gefunden",
    "Address book {addressbook} not found" : "Adressbuch {addressbook} nicht gefunden",
    "Group {group} not found" : "Gruppe {group} wurde nicht gefunden",
    "Could not accept invite" : "Einladung konnte nicht angenommen werden.",
    ...
    "Import" : "Importieren",
    "Are you sure you want to import this contact file?" : "Soll diese Kontaktdatei importiert werden?",
    ...
    "Please confirm team leave" : "Bitte bestätigen Sie, dass Sie das Team verlassen möchten",
    ...
    "Email addresses" : "E-Mail-Adressen",
    "contacts" : "Kontakte",
    "Link-only invite" : "Nur-Link Einladung",
