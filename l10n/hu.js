OC.L10N.register(
    ...
    "Your request to join this circle is pending approval" : "A körhöz való csatlakozási kérelem jóváhagyásra vár",
    ...
    "Show all groups" : "Minden csoport megjelenítése",
    "Collapse groups" : "Csoportok összecsukása",
    "Show all circles" : "Körök megjelenítése",
    ...
    "An error happened during description sync" : "Hiba történt a leírás szinkronizálása közben",
    "An error happened during name sync" : "Hiba történt a név  szinkronizálása közben",
    ...
    "Avatar downloaded from social network" : "Az avatar letöltése befejeződött a közösségi hálózatról",
    "Avatar already up to date" : "Az avatar már naprakész",
    "Avatar download failed" : "Az avatar letöltése nem sikerült",
    ...
    "Unable to retrieve the contact from the server, please check your network connection." : "Nem sikerült lekérni a névjegyet a szerverről, ellenőrizze a hálózati kapcsolatot.",
    "An error occurred while trying to move the contact" : "Hiba történt a névjegy áthelyezése közben",
    ...
    "The list of members is only visible to members of this circle" : "A taglista csak a tagok számára látható.",
    "There is no member in this circle" : "Senki sincs ebben a körben",
    "Add members" : "Tagok hozzáadása",
    "Accept membership request" : "Csatlakozási kérelem elfogadása",
    "Reject membership request" : "Csatlakozási kérelem visszautasítása",
