OC.L10N.register(
    ...
    "Leave circle" : "Залишити коло",
    "Delete circle" : "Вилучити коло",
    ...
    "Show all circles" : "Показувати всі кола",
    "Collapse circles" : "Згорнути кола",
    "This group already exists" : "Така група вже існує",
    "This circle already exists" : "Таке коло вже існує",
    "An error happened during the creation of the circle" : "Помилка під час створення кола",
    ...
    "Enforce password protection on files shared to this circle" : "Налаштувати обов'язкові паролі на файли, до яких було надано доступ в цьому колі",
    "Use a unique password for all shares to this circle" : "Використовувати один пароль для всіх спільних ресурсів у цьому колі",
    ...
    "Circle name" : "Назва кола",
    "Circle owned by {owner}" : "Власник кола {owner}",
    "Request to join" : "Запит на приєднання",
    "Description" : "Опис",
    "There is no description for this circle" : "Відсутній опис цього кола",
    ...
    "Exclude contact from Birthday Calendar" : "Не показувати у календарі днів народжень",
    ...
    "There was an issue adding members to the circle" : "Проблема з додаванням учасників до кола",
    ...
    "Please confirm circle leave" : "Будь ласка, підтвердіть вихід з кола",
    "Could not leave the circle {displayName}" : "Неможливо залишити коло {displayName}",
    "Unable to join the circle" : "Неможливо приєднатися до кола",
    "You are about to delete {circle}.\nAre you sure?" : "Ви намагаєтеся вилучити коло {circle}.\nПродовжити?",
    "Please confirm circle deletion" : "Будь ласка, підтвердіть вилучення кола",
    ...
    "Circles are groups of people that you can create yourself and with whom you can share data. They can be made up of other accounts or groups of accounts of the Nextcloud instance, but also of contacts from your address book or even external people by simply entering their e-mail addresses." : "Кола - це групи людей, які ви можете самі створювати, щоби подалі ділитися з ними даними. До кіл можна включати інші облікові записи, групи облікових записів у вашій хмарі, а також контакти з вашої адресної книги і навіть інших людей - для цього просто зазначте їхні ел. адреси.",
    "Circle" : "Коло",
    "User" : "Користувач",
    "Group" : "Група",
    "Email" : "Ел.пошта",
    ...
    "An error has occurred in circle(s). Check the console for more details." : "Помилка в одному з кіл. Перевірте додаткові дані у консолі.",
