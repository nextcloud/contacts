OC.L10N.register(
    ...
    "Move" : "Move",
    "Unselect {name}" : "Зняти вибір {name}",
    "Select {name}" : "Вибрати {name}",
    "Could not update favorite status" : "Не вдалося оновити статус із зірочкою",
    ...
    "Address book {addressbook} not found" : "Адресну книгу {addressbook} не знайдено",
    ...
    "Could not update favorite state" : "Не вдалося оновити статус із зірочкою",
    ...
    "Choose a team picture" : "Вибрати зображення команди",
    "Please select a valid png or jpg file" : "Виберіть дійсний файл PNG або JPG",
    "Error picking team picture" : "Помилка під час вибору зображення команди",
    "Error cropping avatar picture" : "Помилка під час кадрування зображення",
    "Upload team picture" : "Завантажити зображення команди",
    "Choose from Nextcloud Files" : "Вибрати з файлів у Nextcloud",
    "Edit team picture" : "Редагувати зображення команди",
    "Apply" : "Застосувати",
    ...
    "Create your own teams for sharing. Add Nextcloud users, contacts, or anyone via email." : "Створюйте власні команди для спільної роботи. Додавайте до команд користувачів Nextcloud, ваші контакти або будь-кого через ел. пошту.",
