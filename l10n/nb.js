OC.L10N.register(
    ...
    "Open the contacts app settings" : "Åpne innstillingene for kontakterappen",
    ...
    "This will unshare the address book and every contacts within it" : "Dette vil oppheve delingen av adresseboken og alle kontakter i den",
    "Unshare {addressbook}?" : "Oppheve deling av {addressbook}?",
    ...
    "Memberships must be confirmed/accepted by a Moderator (requires \"Anyone can request membership\")" : "Medlemskap må bekreftes / aksepteres av en moderator (krever \"Alle kan be om medlemskap\")",
