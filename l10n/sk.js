OC.L10N.register(
    ...
    "An open invite already exists." : "Otvorená pozvánka už existuje.",
    "Could not accept invite because no authenticated user was found." : "Pozvánku nebolo možné prijať, pretože sa nenašiel overený používateľ.",
    "The invite provider is invalid or not allowed." : "Poskytovateľ pozvánky je neplatný alebo nie je povolený.",
    "Unable to accept this invitation. You are trying to accept an outgoing invitation." : "Túto pozvánku nie je možné prijať. Pokúšate sa prijať odoslanú pozvánku.",
    "Could not accept invite because the remote provider returned an invalid response." : "Pozvánku nebolo možné prijať, pretože vzdialený poskytovateľ vrátil neplatnú odpoveď.",
    "The remote provider accepted the invite, but this server could not create the local contact." : "Vzdialený poskytovateľ pozvánku prijal, ale tento server nemohol vytvoriť lokálny kontakt.",
    "Cannot resend: no email address" : "Nie je možné znova odoslať: chýba e-mailová adresa",
    "Invite has already been accepted." : "Pozvánka už bola prijatá.",
    "Invite has expired. Please create a new one." : "Platnosť pozvánky vypršala. Vytvorte novú.",
    "This is a copy of an invite sent to you previously by %1$s on %2$s" : "Toto je kópia pozvánky, ktorú vám predtým odoslal používateľ %1$s dňa %2$s",
    "Invite already has an email address." : "Pozvánka už obsahuje e-mailovú adresu.",
    "An open invite for this email already exists." : "Otvorená pozvánka pre túto e-mailovú adresu už existuje.",
    "Could not claim invite for this email; please refresh and try again." : "Pozvánku pre túto e-mailovú adresu nebolo možné uplatniť. Obnovte stránku a skúste to znova.",
    "Could not revert invite after delivery failure. Please refresh and try again." : "Po zlyhaní doručenia nebolo možné pozvánku vrátiť späť. Obnovte stránku a skúste to znova.",
    "OCM invites are disabled." : "Pozvánky OCM sú zakázané.",
    "Recipient email address is invalid." : "E-mailová adresa príjemcu je neplatná.",
    "%1$s via %2$s" : "%1$s prostredníctvom %2$s",
    "%1$s invites you to exchange contact information." : "%1$s vás pozýva na výmenu kontaktných údajov.",
    "This is a copy of the invitation you've sent to %1$s" : "Toto je kópia pozvánky, ktorú ste odoslali používateľovi %1$s",
    "Hi there," : "Ahoj,",
    "%1$s invites you to exchange cloud accounts and contact information." : "%1$s vás pozýva na výmenu cloudových účtov a kontaktných údajov.",
    "This will allow you to share data with each other." : "Umožní vám to navzájom zdieľať údaje.",
    "To accept this invite, click the link below and sign in with your cloud provider:" : "Ak chcete prijať túto pozvánku, kliknite na odkaz nižšie a prihláste sa u svojho poskytovateľa cloudu:",
    "Invitation details:" : "Podrobnosti pozvánky:",
    "Invite code: %1$s" : "Kód pozvánky: %1$s",
    "Encoded invite: %1$s" : "Kódovaná pozvánka: %1$s",
    "To accept this invite, use the url below to sign in with your cloud provider:" : "Ak chcete prijať túto pozvánku, použite adresu URL nižšie a prihláste sa u svojho poskytovateľa cloudu:",
    ...
    "Could not save the setting" : "Nastavenie sa nepodarilo uložiť",
    "Allow updating avatars from social media" : "Povoliť aktualizáciu avatarov zo sociálnych médií",
    "External invitations" : "Externé pozvánky",
    "Allow creating invites without an email address (link-only)" : "Povoliť vytváranie pozvánok bez e-mailovej adresy (iba s odkazom)",
    "Show the \"Copy encoded invite\" button on invite details" : "Zobraziť tlačidlo „Kopírovať kódovanú pozvánku“ v podrobnostiach pozvánky",
    ...
    "Loading invitations…" : "Načítavajú sa pozvánky…",
    "Could not load invitations" : "Pozvánky sa nepodarilo načítať",
    "Retry" : "Opakovať",
    "There are no invitations" : "Žiadne pozvánky",
    "Create invitation" : "Vytvoriť pozvánku",
    "Loading …" : "Načítava sa …",
    ...
    "Close" : "Zavrieť",
    "Choose a team picture" : "Vybrať obrázok tímu",
    ...
    "Please select a valid png or jpg file" : "Vyberte platný súbor PNG alebo JPG",
    "Error picking team picture" : "Chyba pri výbere obrázka tímu",
    "Error cropping avatar picture" : "Chyba pri orezávaní obrázka avatara",
    "An error happened while saving {fields}" : "Došlo k chybe pri ukladaní {fields}.",
    "Team name" : "Názov tímu",
    "Team owner" : "Vlastník tímu",
    "Upload team picture" : "Nahrať obrázok tímu",
    ...
    "Members" : "Členovia",
    "Edit team picture" : "Upraviť obrázok tímu",
    "Apply" : "Použiť",
    "Confirm" : "Potvrdiť",
    "No other contacts available to select as line manager" : "Nie sú k dispozícii žiadne ďalšie kontakty, ktoré by bolo možné vybrať ako nadriadeného",
    ...
    "Move" : "Move",
    "Unselect {name}" : "Zrušiť výber kontaktu {name}",
    "Select {name}" : "Vybrať kontakt {name}",
    "Could not update favorite status" : "Stav obľúbeného kontaktu sa nepodarilo aktualizovať",
    ...
    "Pending" : "Čakajúce",
    "This invite does not look valid. Check that you copied it completely or ask the sender to generate a new one." : "Táto pozvánka nevyzerá ako platná. Skontrolujte, či ste ju skopírovali celú, alebo požiadajte odosielateľa, aby vytvoril novú.",
    "Accept invitation" : "Prijať pozvánku",
    "Accepting will add the inviter to your contacts list and in return, your contact info will be sent to the inviter. From there on you can start sharing data with each other." : "Prijatím pridáte pozývajúcu osobu do svojho zoznamu kontaktov a na oplátku sa jej odošlú vaše kontaktné údaje. Potom môžete začať navzájom zdieľať údaje.",
    "Invite link or code (required)" : "Odkaz alebo kód pozvánky (povinné)",
    "Paste the invite link, or an invite code (token@provider), you received from the other person." : "Prilepte odkaz na pozvánku alebo kód pozvánky (token@provider), ktorý ste dostali od druhej osoby.",
    "Accept" : "Prijať",
    "Please enter an email address." : "Zadajte e-mailovú adresu.",
    ...
    "Encoded invite copied to clipboard" : "Zakódovaná pozvánka bola skopírovaná do schránky",
    "Invite code copied to clipboard" : "Kód pozvánky bol skopírovaný do schránky",
    "Invite link copied to clipboard" : "Odkaz na pozvánku bol skopírovaný do schránky",
    "Copied to clipboard" : "Skopírované do schránky",
    "Failed to copy to clipboard" : "Kopírovanie do schránky zlyhalo",
    "Could not resend invite" : "Pozvánku sa nepodarilo znova odoslať",
    "Invite revoked" : "Pozvánka bola odvolaná",
    "Could not revoke invite" : "Pozvánku sa nepodarilo odvolať",
    "Invite sent to {email}" : "Pozvánka odoslaná na adresu {email}",
    "Could not send invite" : "Pozvánku sa nepodarilo odoslať",
    "No invitation selected" : "Nebola vybratá žiadna pozvánka",
    "Select an invitation on the list to begin" : "Začnite výberom pozvánky zo zoznamu",
    "External invitation" : "Externá pozvánka",
    "Label" : "Štítok",
    "Sent to" : "Odoslané na",
    "Created" : "Vytvorený",
    "Expires" : "Platnosť do",
    "More ways to share" : "Ďalšie možnosti zdieľania",
    "Useful for sharing through a chat app or for manual acceptance." : "Užitočné na zdieľanie prostredníctvom četovacej aplikácie alebo na manuálne prijatie.",
    "Revoke invitation" : "Odvolať pozvánku",
    "Resend email" : "Znova odoslať e-mail",
    "Send via email" : "Odoslať e-mailom",
    "Send invitation via email" : "Odoslať pozvánku e-mailom",
    "{name} invites you to exchange cloud accounts and contact information." : "{name} vás pozýva na výmenu cloudových účtov a kontaktných údajov.",
    "The invite link and code are added automatically when you send the invitation." : "Odkaz a kód pozvánky sa pri odoslaní pozvánky pridajú automaticky.",
    "Recipient email" : "E-mail príjemcu",
    "Invite someone outside your organization to collaborate" : "Pozvite na spoluprácu niekoho mimo svojej organizácie",
    "After the invitee accepts the invite, both of you will appear in each other's contacts list and you can start sharing data with each other." : "Po prijatí pozvánky pozvanou osobou sa obaja zobrazíte vo vzájomných zoznamoch kontaktov a môžete začať navzájom zdieľať údaje.",
    "Send invite via email" : "Odoslať pozvánku e-mailom",
    "Hide email preview" : "Skryť ukážku e-mailu",
    "Show email preview" : "Zobraziť ukážku e-mailu",
    "This is what {recipient} will receive:" : "Toto dostane príjemca {recipient}:",
    "If you do not send an email, you will need to share the invite link yourself." : "Ak e-mail neodošlete, odkaz na pozvánku budete musieť zdieľať sami.",
    "Invite link" : "Odkaz na pozvánku",
    "Copy invite link to clipboard" : "Skopírovať odkaz na pozvánku do schránky",
    "Copy invite code to clipboard" : "Skopírovať kód pozvánky do schránky",
    "Encoded invite" : "Zakódovaná pozvánka",
    "Copy encoded invite to clipboard" : "Skopírovať zakódovanú pozvánku do schránky",
    "Search invites…" : "Hľadať v pozvánkach…",
    "Could not discover that provider. Check the address and try again." : "Tohto poskytovateľa sa nepodarilo nájsť. Skontrolujte adresu a skúste to znova.",
    "Select your server" : "Vyberte svoj server",
    "Type to search" : "Začnite písať",
    "No servers match your search." : "Vyhľadávaniu nezodpovedajú žiadne servery.",
    "No servers are currently available." : "Momentálne nie sú k dispozícii žiadne servery.",
    "Your server not listed? Enter one manually." : "Váš server nie je v zozname? Zadajte ho manuálne.",
    "Continue" : "Pokračovať",
    "You need an invite link for this feature to work." : "Na fungovanie tejto funkcie potrebujete odkaz na pozvánku.",
    ...
    "Generate invitation" : "Vytvoriť pozvánku",
    "This invite link is incomplete. Ask the sender to generate a new one." : "Tento odkaz na pozvánku je neúplný. Požiadajte odosielateľa o vytvorenie nového.",
    "Unable to create the contact." : "Nepodarilo sa vytvoriť kontakt.",
    "Contact not found" : "Kontakt sa nenašiel",
    "Address book {addressbook} not found" : "Adresár {addressbook} sa nenašiel",
    "Group {group} not found" : "Skupina {group} nebola nájdená",
    "Could not accept invite" : "Pozvánku sa nepodarilo prijať",
    "Could not create invite" : "Pozvánku sa nepodarilo vytvoriť",
    ...
    "Create your own teams for sharing. Add Nextcloud users, contacts, or anyone via email." : "Vytvorte si vlastné tímy na zdieľanie. Pridajte používateľov Nextcloudu, kontakty alebo kohokoľvek prostredníctvom e-mailu.",
    "Team" : "Tím",
    "User" : "Užívateľ",
    "Group" : "Skupina",
    "Email" : "Email",
    ...
    "contacts" : "kontakty",
    "Link-only invite" : "Pozvánka iba s odkazom",
    ...
    "Could not update favorite state" : "Stav obľúbenosti sa nepodarilo aktualizovať",
    ...
    "note" : "poznámka",
    "email" : "email",
    "Create your own groups for sharing. Add Nextcloud users, contacts, or anyone via email." : "Vytvorte si vlastné skupiny na zdieľanie. Pridajte používateľov Nextcloudu, kontakty alebo kohokoľvek prostredníctvom e-mailu."
},
