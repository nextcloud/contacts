OC.L10N.register(
    ...
    "Select chart …" : "Wybierz wykres…",
    "_Imported %n contact (skipped %d)_::_Imported %n contacts (skipped %d)_" : ["Zaimportowano %n kontakt (pominięto %d)","Zaimportowano %n kontaktów (pominięto %d)","Zaimportowano %n kontaktów (pominięto %d)","Zaimportowano %n kontakty (pominięto %d)"]
},
