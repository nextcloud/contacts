OC.L10N.register(
    ...
    "_Imported %n contact_::_Imported %n contacts_" : ["Zaimportowano %n kontakt","Zaimportowano %n kontaktów","Zaimportowano %n kontakty","Zaimportowano %n kontakty"],
    "_(skipped %n contact)_::_(skipped %n contacts)_" : ["(pominięto %n kontakt)","(pominięto %n kontaktów)","(pominięto %n kontakty)","(pominięto %n kontakty)"],
    "Contacts" : "Kontakty",
    ...
    "Tried to drop an invalid contact!" : "Próbowano zrzucić nieprawidłowy kontakt!",
    "Rename" : "Zmień nazwę",
    "Export" : "Eksportuj",
    ...
    "_Shared with {num} entity_::_Shared with {num} entities_" : ["Udostępniono dla {num} podmiotu","Udostępniono dla {num} podmiotów","Udostępniono dla {num} podmiotów","Udostępniono dla  {num} podmiotów"],
    "Copied" : "Skopiowano",
    ...
    "{addressbookname} (Hidden)" : "{addressbookname} (ukryta)",
    "Download" : "Pobierz",
    "Show" : "Pokaż",
    ...
    "can create and edit" : "może tworzyć i edytować",
    ...
    "Sort contacts by" : "Sortuj kontakty według",
    "Manages" : "Zarządza",
    "Oversees" : "Nadzoruje",
    ...
    "This will create a regular folder shared with the team. To create a Team Folder, please contact your {productName} administrator" : "Zostanie utworzony zwykły folder udostępniony zespołowi. Aby utworzyć folder zespołu, skontaktuj się z administratorem {productName}",
    ...
    "Unknown resource type" : "Nieznany typ zasobu",
    "Team calendar \"{resourceName}\" created and shared with team" : "Kalendarz zespołu \"{resourceName}\" został utworzony i udostępniony zespołowi",
    "{resourceType} \"{resourceName}\" created and shared with team" : "{resourceType} \"{resourceName}\" został utworzony i udostępniony zespołowi",
    "A calendar named \"{name}\" already exists. Please choose a different name." : "Kalendarz o nazwie \"{name}\" już istnieje. Wybierz inną nazwę.",
    "Failed to create {resourceType}: {error}" : "Nie udało się utworzyć {resourceType}: {error}",
    "Please select a valid png or jpg file" : "Wybierz prawidłowy plik PNG lub JPG",
    "Error picking team picture" : "Błąd podczas wybierania zdjęcia zespołu",
    "Error cropping avatar picture" : "Błąd podczas przycinania zdjęcia awatara",
    "An error happened while saving {fields}" : "Wystąpił błąd podczas zapisywania {fields}",
    "Team name" : "Nazwa zespołu",
    "Team owner" : "Właściciel zespołu",
    "Upload team picture" : "Prześlij zdjęcie zespołu",
    "Choose from Nextcloud Files" : "Wybierz z plików Nextcloud",
    ...
    "Members" : "Członkowie",
    "Edit team picture" : "Edytuj zdjęcie zespołu",
    "Apply" : "Zastosuj",
    "Confirm" : "Potwierdź",
    ...
    "This contact cannot be moved" : "Tego kontaktu nie można przenieść",
    "This contact cannot be grouped" : "Tego kontaktu nie można pogrupować",
    "Add contacts to groups" : "Dodaj kontakty do grup",
    "Move contacts to addressbook" : "Przenieś kontakty do książki adresowej",
    "Select groups" : "Wybierz grupy",
    "Select addressbook" : "Wybierz książkę adresową",
    "Selected contacts" : "Wybrane kontakty",
    "Please note that only {count} of the {total} contacts can be added to a group" : "Uwaga: tylko {count}z {total} kontaktów można dodać do grupy",
    "Please note that only {count} of the {total} contacts can be moved" : "Uwaga: tylko {count} z {total} kontaktów można przenieść",
    "Move" : "Move",
    "Could not update favorite status" : "Nie udało się zaktualizować statusu ulubionych",
    "from {addressbook}" : "z {addressbook}",
    "Remove from favorites" : "Remove from favorites",
    "Add to favorites" : "Add to favorites",
    "Confirm merging contacts" : "Potwierdź scalanie kontaktów",
    "The selected contacts have conflicting information. Choose which information to keep" : "Wybrane kontakty mają sprzeczne informacje. Wybierz, które informacje zachować",
    "Contacts can be merged" : "Kontakty mogą zostać scalone",
    "Groups" : "Grupy",
    "Select groups to add the merged contact to" : "Wybierz grupy, do których dodać scalony kontakt",
    "Merge contacts" : "Scal kontakty",
    "_Delete {number} contact_::_Delete {number} contacts_" : ["Usuń {number} kontakt","Usuń {number} kontakty","Usuń {number} kontaktów","Usuń {number} kontaktów"],
    "Please select at least one editable contact to delete" : "Wybierz co najmniej jeden edytowalny kontakt do usunięcia",
    "Please select two editable contacts to merge" : "Wybierz dwa edytowalne kontakty do scalenia",
    "_Add {number} contact to group_::_Add {number} contacts to group_" : ["Dodaj {number} kontakt do grupy","Dodaj {number} kontaktów do grupy","Dodaj {number} kontaktów do grupy","Dodaj {number} kontakty do grupy"],
    "Please select at least one editable contact to add to a group" : "Wybierz co najmniej jeden edytowalny kontakt, aby dodać go do grupy",
    "_Move {number} contact to addressbook_::_Move {number} contacts to addressbook_" : ["Przenieś {number} kontakt do książki adresowej","Przenieś {number} kontaktów do książki adresowej","Przenieś {number} kontaktów do książki adresowej","Przenieś {number} kontakty do książki adresowej"],
    "Please select at least one editable contact to move to an addressbook" : "Wybierz co najmniej jeden edytowalny kontakt, aby przenieść go do książki adresowej",
    ...
    "Are you sure you want to leave this team? This action cannot be undone." : "Czy na pewno chcesz opuścić ten zespół? Tej operacji nie można cofnąć.",
    "Leave team failed." : "Nie udało się opuścić zespołu.",
    ...
    "Add to {team}" : "Dodaj do {team}",
    "Invite members to {team}" : "Zaproś członków do {team}",
    "Pending" : "Oczekuje",
    ...
    "JavaScript URIs are not allowed" : "Adresy URI JavaScript nie są dozwolone",
    "Notes" : "Notatki",
    ...
    "Confirm enabling federation" : "Potwierdź włączenie federacji",
    "Enabling this will prevent {circle} from being a member of other teams.\nAre you sure?" : "Włączenie tego uniemożliwi {circle} bycie członkiem innych zespołów.\nCzy na pewno?",
    ...
    "Create your own teams for sharing. Add Nextcloud users, contacts, or anyone via email." : "Twórz własne zespoły do udostępniania. Dodawaj użytkowników Nextcloud, kontakty lub dowolne osoby przez e-mail",
    "Team" : "Zespół",
    "User" : "Użytkownik",
    "Group" : "Grupa",
    "Email" : "E-mail",
    ...
    "Allow federated members" : "Zezwalaj członkom federacyjnym",
    "Privacy" : "Prywatność",
