OC.L10N.register(
    ...
    "Unable to retrieve the contact from the server, please check your network connection." : "Kan het contact niet ophalen van de server. Controleer uw netwerkverbinding.",
