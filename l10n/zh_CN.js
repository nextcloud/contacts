OC.L10N.register(
    ...
    "Please select a valid png or jpg file" : "请选择一个有效的 png 或 jpg 文件",
    "Error picking team picture" : "选择团队图片时出错",
    "Error cropping avatar picture" : "裁剪头像图片时出错",
    "An error happened while saving {fields}" : "保存 {fields} 时出错",
    "Team name" : "团队名称",
    "Team owner" : "团队所有者",
    "Upload team picture" : "上传团队图片",
    ...
    "Move" : "移动",
    "Could not update favorite status" : "无法更新收藏状态",
    ...
    "Not grouped" : "未分组",
    "Create your own teams for sharing. Add Nextcloud users, contacts, or anyone via email." : "创建您自己的共享团队。您可以添加 Nextcloud 用户、联系人或通过电子邮件添加任何人。",
    "Team" : "团队",
    "User" : "用户",
    "Group" : "群组",
    "Email" : "电子邮件",
    ...
    "Could not update favorite state" : "无法更新收藏状态",
    ...
    "No other contacts available to select as line manager" : "没有其他联系人可供选择担任部门经理",
    "note" : "备注",
    "email" : "电子邮件",
