OC.L10N.register(
    ...
    "Your request to join this circle is pending approval" : "您加入这个圈子的请求正在等待批准",
    ...
    "Enforce password protection on files shared to this circle" : "对分享到该圈子中的文件强制使用密码保护",
    "Use a unique password for all shares to this circle" : "对分享到该圈子中的文件使用独立密码",
    ...
    "This circle will only be visible to you. Other members will not be able to see or use it." : "这个圈子仅对您可见，其他成员无法看见或使用它。",
    "Local circle" : "本地圈子",
    "This circle will not be shared with the other instances of the global scale" : "这个圈子不会与全球范围内的其他实例共享 ",
    "Create circle" : "创建圈子",
    ...
    "Please confirm circle leave" : "请确认离开此圈子",
    ...
    "An error has occurred in circle(s). Check the console for more details." : "圈子中出现错误。请查看控制台以获取详细信息。",
