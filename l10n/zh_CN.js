OC.L10N.register(
    ...
    "Use a unique password for all shares to this circle" : "对分享到该圈子中的文件使用独一无二的密码",
    "Unique password …" : "独一无二的密码 …",
    "Save" : "保存",
    "Change unique password" : "修改独一无二的密码",
    ...
    "The contact does not exists on the server anymore." : "服务器上不再存在该联系人。",
    ...
    "You currently have no access to the memberlist" : "这个圈子没有成员",
    "Add members" : "添加成员",
    ...
    "Circles allow you to create groups with other users on a Nextcloud instance and share with them." : "Circles 允许你在 Nextcloud 实例上与其他用户创建组并与他们分享。",
    "Circle" : "圈子",
    "User" : "用户",
    "Group" : "小组",
    "Email" : "电子邮件",
