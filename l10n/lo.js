OC.L10N.register(
    ...
    "_Imported %n contact_::_Imported %n contacts_" : ["Imported %n contacts"],
    "Contacts" : "ຕິດຕໍ່",
    ...
    "_Shared with {num} entity_::_Shared with {num} entities_" : ["Shared with {num} entities"],
    "Copied" : "Copied",
    ...
    "_%n contact_::_%n contacts_" : ["%n contacts"],
    "_%n group_::_%n groups_" : ["%n groups"],
    ...
    "_Delete {number} contact_::_Delete {number} contacts_" : ["Delete {number} contacts"],
    ...
    "_{success} contact added to {name}_::_{success} contacts added to {name}_" : ["{success} contacts added to {name}"],
    "_Adding {success} contact to {name}_::_Adding {success} contacts to {name}_" : ["Adding {success} contacts to {name}"],
    "_{count} error_::_{count} errors_" : ["{count} errors"],
    "_Importing %n contact into {addressbook}_::_Importing %n contacts into {addressbook}_" : ["Importing %n contacts into {addressbook}"],
    "_Done importing %n contact into {addressbook}_::_Done importing %n contacts into {addressbook}_" : ["Done importing %n contacts into {addressbook}"],
    ...
    "_{failed} contact failed to be read_::_{failed} contacts failed to be read_" : ["{failed} contacts failed to be read"],
