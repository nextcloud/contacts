OC.L10N.register(
    ...
    "_Imported %n contact_::_Imported %n contacts_" : ["Импортирован %n контакт","Импортировано %n контакта","Импортировано %n контактов","Импортировано %n контактов"],
    "_(skipped %n contact)_::_(skipped %n contacts)_" : ["(пропущен %n контакт)","(пропущено %n контакта)","(пропущено %n контактов)","(пропущено %n контактов)"],
    "Contacts" : "Контакты",
    ...
    "Tried to drop an invalid contact!" : "Попытка удалить неверный контакт!",
    ...
    "{addressbookname} (Hidden)" : "{addressbookname} (Скрыт)",
    "Download" : "Скачать",
    "Show" : "Показать",
    ...
    "can create and edit" : "разрешено создавать и редактировать",
    ...
    "Sort contacts by" : "Сортировать контакты по",
    "Manages" : "Управляет",
    "Oversees" : "Наблюдает",
    "Confirm" : "Подтвердить",
    ...
    "This contact cannot be moved" : "Этот контакт не может быть перемещён",
    "This contact cannot be grouped" : "Этот контакт не может быть добавлен в группу",
    "Add contacts to groups" : "Добавить контакты в группы",
    "Move contacts to addressbook" : "Переместить контакты в адресную книгу",
    "Select groups" : "Выбрать группы",
    "Select addressbook" : "Выбрать адресную книгу",
    "Selected contacts" : "Выбранные контакты",
    "Please note that only {count} of the {total} contacts can be added to a group" : "Обратите внимание, что в группу можно добавить только {count} из {total} контактов",
    "Please note that only {count} of the {total} contacts can be moved" : "Обратите внимание, что в переместить можно только {count} из {total} контактов",
    "Move" : "Переместить",
    "Unselect {name}" : "Отменить выделение {name}",
    "Select {name}" : "Выбрать {name}",
    "Could not update favorite status" : "Не удалось обновить статус «В избранном»",
    "from {addressbook}" : "из {addressbook}",
    "Remove from favorites" : "Удалить из избранного",
    "Add to favorites" : "Добавить в избранные",
    "Confirm merging contacts" : "Подтвердить объединение контактов",
    ...
    "Contacts can be merged" : "Контакты могут быть объединены",
    "Groups" : "Группы",
    ...
    "This will create a regular folder shared with the team. To create a Team Folder, please contact your {productName} administrator" : "В результате будет создана обычная папка, доступная для всей команды. Чтобы создать Командную папку, обратитесь к своему администратору {productName}",
    "Talk conversation" : "Обсуждение Talk",
    ...
    "Create your own groups for sharing. Add Nextcloud users, contacts, or anyone via email." : "Создавайте собственные группы для обмена данными. Добавляйте пользователей Nextcloud, контакты или любых других людей по электронной почте.",
    "Moderator" : "Модератор",
    "Admin" : "Администратор",
    "Owner" : "Владелец",
    "Invites" : "Приглашения",
