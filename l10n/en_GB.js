OC.L10N.register(
    ...
    "Image is too big (max 1MB)." : "Image is too big (max 1MB).",
    ...
    "Cancel" : "Cancel",
    "This contact is not yet synced. Edit it to save it to the server." : "This contact is not yet synced. Edit it to save it to the server.",
    ...
    "The contact does not exists on the server anymore." : "The contact does not exists on the server anymore.",
    ...
    "You currently have no access to the memberlist" : "You currently have no access to the member list",
    ...
    "Circles allow you to create groups with other users on a Nextcloud instance and share with them." : "Circles allow you to create groups with other users on a Nextcloud instance and share with them.",
    "Circle" : "Circle",
    "User" : "User",
    "Group" : "Group",
    "Email" : "Email",
    ...
    "Some circle(s) an error occurred. Check the console for more details." : "Some circle(s) an error occurred. Check the console for more details.",
