OC.L10N.register(
    ...
    "_Imported %n contact (skipped %d)_::_Imported %n contacts (skipped %d)_" : ["Увезен је %n контакт (прескочен %d)","Увезена су %n контакта (прескочено %d)","Увезено је %n контаката (прескочено %d)"],
    "Contacts" : "Контакти",
