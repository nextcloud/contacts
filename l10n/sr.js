OC.L10N.register(
    ...
    "The contact does not exists on the server anymore." : "Контакт више не постоји на серверу.",
    ...
    "Circles allow you to create groups with other users on a Nextcloud instance and share with them." : "Кругови вам омогућавају да креирате групе са осталим корсницима Nextcloud инстанце и да делите са њима.",
    "Circle" : "Круг",
    "User" : "Корисник",
    "Group" : "Група",
    "Email" : "Е-пошта",
