OC.L10N.register(
    ...
    "_Imported 1 contact_::_Imported %n contacts_" : ["Naimportován 1 kontakt","Naimportovány %n kontakty","Naimportováno %n kontaktů","Naimportovány %n kontakty"],
    "_Imported 1 contact (skipped %d)_::_Imported %n contacts (skipped %d)_" : ["Naimportován 1 kontakt (přeskočeno %d)","Naimportovány %n kontakty (přeskočeno %d)","Naimportováno %n kontaktů (přeskočeno %d)","Naimportovány %n kontakty (přeskočeno %d)"],
    "Contacts" : "Kontakty",
