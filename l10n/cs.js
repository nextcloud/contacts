OC.L10N.register(
    ...
    "_Imported %n contact_::_Imported %n contacts_" : ["Naimportován %n kontakt","Naimportovány %n kontakty","Naimportováno %n kontaktů","Naimportovány %n kontakty"],
    "_(skipped %n contact)_::_(skipped %n contacts)_" : ["(přeskočen %n kontakt)","(přeskočeny %n kontakty)","(přeskočeno %n kontaktů)","(přeskočeny %n kontakty)"],
    "Contacts" : "Kontakty",
    ...
    "can create and edit" : "může vytvářet a upravovat",
    ...
    "Sort contacts by" : "Řadit kontakty podle",
    "Manages" : "Spravuje",
    "Oversees" : "Dohlíží",
    ...
    "Team calendar \"{resourceName}\" created and shared with team" : "Týmový kalendář „{resourceName}“ vytvořen a nasdílen týmu",
    "{resourceType} \"{resourceName}\" created and shared with team" : "{resourceType} „{resourceName}“ vytvořeno a nasdíleno týmu",
    "A calendar named \"{name}\" already exists. Please choose a different name." : "Kalendář nazvaný „{name}“ už existuje. Zvolte jiný název.",
    ...
    "Confirm enabling federation" : "Potvrďte zapnutí federování",
    "Enabling this will prevent {circle} from being a member of other teams.\nAre you sure?" : "Zapnutí tohoto bude bránit {circle} aby bylo členem ostatních týmů.\nOpravdu to chcete?",
    ...
    "Allow federated members" : "Umožnit federované členy",
    "Privacy" : "Soukromí",
    "Visible to everyone" : "Viditelné všem",
    "users" : "uživatelé",
    "Users" : "Uživatelé",
    "groups" : "skupiny",
    "federated users" : "fedorovaní uživatelé",
