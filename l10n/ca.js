OC.L10N.register(
    ...
    "Click to copy the link to your clipboard" : "Feu clic per copiar l'enllaç al porta-retalls",
    "Toggle sharing" : "Canviar compartició",
    "Delete" : "Suprimeix",
    "Rename" : "Renombra",
    ...
    "Only these special characters are allowed: -_.!?#|()" : "Només es permeten aquests caràcters especials: -_.!? # | ()",
    "Address book could not be created." : "No s'ha pogut crear la llibreta d'adreces.",
    "The selected image is too big (max 1MB)" : "La imatge seleccionada és massa gran (màxim 1MB)",
    "This card is corrupted and has been fixed. Please check the data and trigger a save to make the changes permanent." : "Aquesta targeta estava corrompuda i s'ha arreglat. Comprova la informació i guarda-la per fer els canvis permanents.",
    ...
    "Importing..." : "Important...",
    "Select your addressbook" : "Escull la teva llibreta d'adreces",
    ...
    "You don't have permission to write to this addressbook." : "No tens permisos per escriure a aquesta llibreta d'adreces.",
    "Contact could not be created." : "No s'ha pogut crear el contacte.",
    "No contacts in file. Only vCard files are allowed." : "No hi ha contactes al fitxer. Només estan permesos fitxers vCard.",
    ...
    "Contact could not be saved." : "No s'ha pogut desar el contacte.",
    "Waiting for the server to be ready..." : "Esperant que el servidor estigui llest...",
