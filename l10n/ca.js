OC.L10N.register(
    ...
    "Please select a team" : "Seleccioneu un equip",
    "Loading team…" : "S'està carregant l'equip…",
    ...
    "Manage team" : "Administrar l'equip",
    "Leave team" : "Abandonar l'equip",
    ...
    "Collapse teams" : "Col·lapse els equips",
    "Group name cannot be empty" : "El nom del grup no pot estar buit",
    "This group already exists" : "Aquest grup ja existeix",
    "An error occurred while creating the group" : "S'ha produït un error en crear el grup",
    "This team already exists" : "Aquest equip ja existeix",
    "An error happened during the creation of the team" : "S'ha produït un error durant la creació de l'equip",
    ...
    "Teams" : "Equips",
    "Create a new team" : "Crea un nou equip",
    ...
    "This will unshare the address book and every contacts within it" : "Això deixarà de compartir la llibreta d'adreces i tots els contactes que hi hagi",
    "Unshare {addressbook}?" : "Vols deixar de compartir {addressbook}?",
    ...
    "Download" : "Baixa",
    "Show" : "Mostra",
    "Unshare from me" : "Deixa de compartir amb mi",
    ...
    "Enforce password protection on files shared to this team" : "Força la protecció amb contrasenya als fitxers compartits amb aquest equip",
    "Use a unique password for all shares to this team" : "Utilitzeu una contrasenya única per a totes les comparticions d'aquest equip",
    ...
    "Your request to join this team is pending approval" : "La teva sol·licitud per unir-te a aquest equip està pendent d'aprovació",
    ...
    "New team name" : "Nou nom de l'equip",
    "Personal team" : "Equip personal",
    "This team will only be visible to you. Other members will not be able to see or use it." : "Aquest equip només serà visible per a tu. Els altres membres no el podran veure ni utilitzar.",
    "Local team" : "Equip local",
    "This team will not be shared with the other instances of the global scale" : "Aquest equip no es compartirà amb les altres instàncies de l'escala global",
    "Create team" : "Crea equip",
    ...
    "There was an issue adding members to the team" : "Hi ha hagut un problema en afegir membres a l'equip",
    "Team members" : "Membres de l'equip",
    "Loading members list …" : "S'està carregant la llista de membres …",
    "The list of members is only visible to members of this team" : "La llista de membres només és visible per als membres d'aquest equip",
    ...
    "Import" : "Importa",
    "Are you sure you want to import this contact file?" : "Esteu segur que voleu importar aquest fitxer de contacte?",
    "Could not copy" : "No s'ha pogut copiar",
    "Join team" : "Uneix-te a l'equip",
    "You are about to leave {circle}.\nAre you sure?" : "Esteu a punt d'abandonar {circle}.\nSegur que voleu continuar?",
    "Please confirm team leave" : "Si us plau, confirmeu la sortida de l'equip",
    "Could not leave the team {displayName}" : "No s'ha pogut abandonar l'equip {displayName}",
    "Unable to join the team" : "No es pot unir a l'equip",
    "You are about to delete {circle}.\nAre you sure?" : "Esteu a punt de suprimir {circle}.\nSegur que voleu continuar?",
    "Please confirm team deletion" : "Si us plau, confirmeu la supressió de l'equip",
    "Unable to delete the team" : "No es pot suprimir l'equip",
    ...
    "Teams are groups of people that you can create yourself and with whom you can share data. They can be made up of other accounts or groups of accounts of the Nextcloud instance, but also of contacts from your address book or even external people by simply entering their e-mail addresses." : "Els equips són grups de persones que pots crear tu mateix i amb qui pots compartir dades. Poden estar formats per altres comptes o grups de comptes de la instància Nextcloud, però també per contactes de la vostra llibreta d'adreces o fins i tot persones externes simplement introduint les seves adreces de correu electrònic.",
    "Team" : "Equip",
    "User" : "Usuari",
    "Group" : "Grup",
    ...
    "Memberships must be confirmed/accepted by a Moderator (requires \"Anyone can request membership\")" : "Els membres han de ser confirmats/acceptats per un moderador (requereix \"Qualsevol persona pot sol·licitar la subscripció\")",
    ...
    "Prevent teams from being a member of another team" : "Evitar que els equips siguin membres d'un altre equip",
    "users" : "usuaris",
    "Users" : "Usuaris",
    "groups" : "grups",
    "Groups" : "Grups",
    ...
    "Place of death" : "Lloc de la mort",
    ...
    "Line manager" : "Responsable de línia",
    ...
    "Manager" : "Gerent",
    "Members" : "Membres",
    "Manage members" : "Administrar els membres",
    "Show team details" : "Mostra els detalls de l'equip"
},
