OC.L10N.register(
    ...
    "_Imported %n contact_::_Imported %n contacts_" : ["Tuotiin %n yhteystieto","Tuotiin %n yhteytietoa"],
    ...
    "{addressbookname} (Hidden)" : "{addressbookname} (piilotettu)",
    "Download" : "Lataa",
    "Show" : "Näytä",
    ...
    "Sort contacts by" : "Järjestä yhteystiedot tämän mukaan:",
    "Manages" : "Johtaa",
    "Oversees" : "Valvoo",
    ...
    "Unknown resource type" : "Tuntematon resurssityyppi",
    ...
    "No shared items with this contact" : "Ei jakoja tämän yhteystiedon kanssa",
    ...
    "Groups" : "Ryhmät",
    "_Delete {number} contact_::_Delete {number} contacts_" : ["Poista {number} yhteystieto","Poista {number} yhteystietoa"],
    "Are you sure you want to proceed?" : "Haluatko varmasti jatkaa?",
    "Add to {group}" : "Lisää ryhmään {group}",
    "Add members to {group}" : "Lisää jäseniä ryhmään {group}",
    ...
    "Are you sure you want to leave this team? This action cannot be undone." : "Haluatko varmasti poistua tästä tiimistä? Tätä toimintoa ei voi perua.",
