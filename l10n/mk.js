OC.L10N.register(
    ...
    "The contact does not exists on the server anymore." : "Контактот повеќе не постои на серверот.",
    ...
    "Circles allow you to create groups with other users on a Nextcloud instance and share with them." : "Круговите ви дозволуваат да креирате групи со други корисници на Nextcloud и да споделувате со нив.",
    "Circle" : "Круг",
    "User" : "Корисник",
    "Group" : "Група",
    "Email" : "Е-пошта",
    ...
    "Some circle(s) an error occurred. Check the console for more details." : "Во некои круг(ови) се појави грешка. Проверете ја конзолата за повеќе детали.",
