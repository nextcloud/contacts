...
* **l10n:** Update translations from Transifex ([af64f7a](https://github.com/nextcloud/contacts/commit/af64f7abd590d15ef305e27c1c32d4f33c25ff79))
* **l10n:** Update translations from Transifex ([231ca4e](https://github.com/nextcloud/contacts/commit/231ca4e04367bd19b8a44200c48712a90fc42ec1))
* **l10n:** Update translations from Transifex ([3381594](https://github.com/nextcloud/contacts/commit/3381594e3c0484e7745cebae9351c5ee2dfd2a3d))
* **l10n:** Update translations from Transifex ([157fc25](https://github.com/nextcloud/contacts/commit/157fc2573bb9d3a0aa4570d623c09e9daedfc09b))
* **l10n:** Update translations from Transifex ([4846b4e](https://github.com/nextcloud/contacts/commit/4846b4e6008c3baf55ca61791b4cfb8600cdbebd))
* **l10n:** Update translations from Transifex ([84b17e8](https://github.com/nextcloud/contacts/commit/84b17e8ebc0082e60c1769a4754d979b87d4876d))
* **l10n:** Update translations from Transifex ([d192e70](https://github.com/nextcloud/contacts/commit/d192e708ee05a4ecd13ee0b33980008d098bf7c7))
* **l10n:** Update translations from Transifex ([1c4248d](https://github.com/nextcloud/contacts/commit/1c4248d9f6126770f731c4a72608bea5487ca3a3))
* **l10n:** Update translations from Transifex ([d46b937](https://github.com/nextcloud/contacts/commit/d46b93724e0c1fe807239f608878edaeacdc7009))
* **l10n:** Update translations from Transifex ([afccc1a](https://github.com/nextcloud/contacts/commit/afccc1ab8b42050eb7288cfaef5684973c9b84f6))
* **l10n:** Update translations from Transifex ([4442630](https://github.com/nextcloud/contacts/commit/4442630b65df2871f4fc8a6b12bd7db3bea94302))



## [7.3.8](https://github.com/nextcloud/contacts/compare/v7.3.7...v7.3.8) (2025-12-02)


### Bug Fixes

* **l10n:** Update translations from Transifex ([d51bff7](https://github.com/nextcloud/contacts/commit/d51bff74c543149566ce213850e6958417021742))
* **l10n:** Update translations from Transifex ([b8b37d4](https://github.com/nextcloud/contacts/commit/b8b37d46dc62ac4381e2e9ccea692ee2eb1e86c6))
* **l10n:** Update translations from Transifex ([b8562ef](https://github.com/nextcloud/contacts/commit/b8562ef302d91042729b3940048eaeb0e919cff4))
* **l10n:** Update translations from Transifex ([b82e67d](https://github.com/nextcloud/contacts/commit/b82e67d82e9e73b6bfb1c165e65837f5b94c3b2b))
* **l10n:** Update translations from Transifex ([14f24d1](https://github.com/nextcloud/contacts/commit/14f24d1f9bf580d91aecafd8e7f0fb456b0b4a22))
* **l10n:** Update translations from Transifex ([7906ef4](https://github.com/nextcloud/contacts/commit/7906ef4c96eaa2486bd4cb57c09a7f3f754f83d4))
* **l10n:** Update translations from Transifex ([3c443e2](https://github.com/nextcloud/contacts/commit/3c443e2b02b69ad494fc450b3973b000ffa49e4f))
* **l10n:** Update translations from Transifex ([8331f11](https://github.com/nextcloud/contacts/commit/8331f112c5c22fb4412a618e40efe9909a116005))
* **l10n:** Update translations from Transifex ([45fa122](https://github.com/nextcloud/contacts/commit/45fa122db78c667177900f4631785376062b9ddf))
* **l10n:** Update translations from Transifex ([1dba90d](https://github.com/nextcloud/contacts/commit/1dba90ddc61a8387e7808c9a959717c21d53177e))
* **l10n:** Update translations from Transifex ([02359e9](https://github.com/nextcloud/contacts/commit/02359e9dcd572b1796a812b878357c316f27cc08))
* **settings:** add label for sorting ([113e901](https://github.com/nextcloud/contacts/commit/113e901454a8a7a299ce81445059fdf084bf0ec1))
...
* **contact:** Add normalized phone numbers to searchData ([4bfddd2](https://github.com/nextcloud/contacts/commit/4bfddd2f8dda8e5fb8631e51714467595f6a209c))
* **contact:** don't add metadata properties and property names to searchData ([899d512](https://github.com/nextcloud/contacts/commit/899d51293f61f4c2a263443a28f06b5f03e771e9)), closes [#1176](https://github.com/nextcloud/contacts/issues/1176)
* **contact:** include phone numbers when getting contacts for address book ([139df7a](https://github.com/nextcloud/contacts/commit/139df7aee0a8feacef85de147a82af5f5bc37c08)), closes [#3112](https://github.com/nextcloud/contacts/issues/3112)
* **ContactsList:** don't choke when filtering for `+` ([9cb45fb](https://github.com/nextcloud/contacts/commit/9cb45fb8388f44fe23a6dc1bfd6b409b867d3c3c))
* **l10n:** Update translations from Transifex ([ff44825](https://github.com/nextcloud/contacts/commit/ff448252547b33a487e68c4ffa8392783dc90f7b))
* **l10n:** Update translations from Transifex ([2de8a50](https://github.com/nextcloud/contacts/commit/2de8a5096b0a3c2c17cbdc7493eae9109f5e1395))
* **l10n:** Update translations from Transifex ([ba7c184](https://github.com/nextcloud/contacts/commit/ba7c184413781c06f56f41389ac665e95f9b5f76))
* **l10n:** Update translations from Transifex ([1b68b68](https://github.com/nextcloud/contacts/commit/1b68b684a0cef479d4091b930a0f177c04915de0))
* **l10n:** Update translations from Transifex ([a5fe776](https://github.com/nextcloud/contacts/commit/a5fe776dd8f84d008776c0de7e7a91b2b4c248f9))
...
* do not allow to exclude system accounts from the bday calendar ([19c61ae](https://github.com/nextcloud/contacts/commit/19c61ae06df4ee1f25c8274547115270f215aff5))
* duplication of address books requests ([4e19344](https://github.com/nextcloud/contacts/commit/4e193441db8d2f837dca0be16dc058321c77e7c8))
* **l10n:** Update translations from Transifex ([c4b72dc](https://github.com/nextcloud/contacts/commit/c4b72dc1f18ca4b978127324d2b8bd7b91ff550d))
* **l10n:** Update translations from Transifex ([7f2c142](https://github.com/nextcloud/contacts/commit/7f2c142e16664f23aa40db3883575547e6e6dc4b))
* **l10n:** Update translations from Transifex ([bd9eafa](https://github.com/nextcloud/contacts/commit/bd9eafa85c19136b99b417d682c884d3e5f0e9f2))
* **l10n:** Update translations from Transifex ([e593f5c](https://github.com/nextcloud/contacts/commit/e593f5c9d2e5468c86f56266d75d53a1919cd0fd))
* resource url ([794b1af](https://github.com/nextcloud/contacts/commit/794b1afe2e87264a41ca5eb4a5312c10aa684a8d))



## [7.3.1](https://github.com/nextcloud/contacts/compare/v7.3.0...v7.3.1) (2025-09-16)


### Bug Fixes

* don't immediately update a vCard when changing the avatar ([b985155](https://github.com/nextcloud/contacts/commit/b9851551d21c20380db45c5d73edb4a12442f48b))
* generate rev depending on card version ([43ecfc5](https://github.com/nextcloud/contacts/commit/43ecfc588bb2881786bee09f7d6f17f54e4036b6))
* **l10n:** Update translations from Transifex ([0164ebc](https://github.com/nextcloud/contacts/commit/0164ebc0056c7bb0c0c4e8198d35cb4b6e0ebcb3))
* **l10n:** Update translations from Transifex ([760f93d](https://github.com/nextcloud/contacts/commit/760f93d26723774404afd4ca8f449d2042c2e69e))
* **l10n:** Update translations from Transifex ([d0ab3c8](https://github.com/nextcloud/contacts/commit/d0ab3c806b6a166569b7f34db008158611e956ea))
* **l10n:** Update translations from Transifex ([fc4edd6](https://github.com/nextcloud/contacts/commit/fc4edd6d20cce75650a4c934b53b4a5ecd79555d))
* **l10n:** Update translations from Transifex ([5f57b99](https://github.com/nextcloud/contacts/commit/5f57b991d839166e3a992439af24caa2266fd97a))
* **l10n:** Update translations from Transifex ([c01ed10](https://github.com/nextcloud/contacts/commit/c01ed102862017fd3c9bf5a6e0a7f4e1df72e052))
* **l10n:** Update translations from Transifex ([f50da68](https://github.com/nextcloud/contacts/commit/f50da683d274f5eca44e8e507d5a9de85500aee4))
* **l10n:** Update translations from Transifex ([b43bbe3](https://github.com/nextcloud/contacts/commit/b43bbe38508703b69c832f373f2608087c30c810))
* **l10n:** Update translations from Transifex ([b847843](https://github.com/nextcloud/contacts/commit/b84784339ad3d6dc6876bbeb54084e64e7ccfe80))
* **l10n:** Update translations from Transifex ([521e050](https://github.com/nextcloud/contacts/commit/521e050d39c21557e5f39980d8dfb5a57309c11b))
* **l10n:** Update translations from Transifex ([593ad72](https://github.com/nextcloud/contacts/commit/593ad72fe733fdcefd36775f8f5a321a3d28e5a9))
* **l10n:** Update translations from Transifex ([f2f15e7](https://github.com/nextcloud/contacts/commit/f2f15e79148b7df5034a13a7417f1bfbd4311743))
* **l10n:** Update translations from Transifex ([bdac6bf](https://github.com/nextcloud/contacts/commit/bdac6bf33fa083fde1baceb71fca4211381d1025))
* **l10n:** Update translations from Transifex ([a2e80f2](https://github.com/nextcloud/contacts/commit/a2e80f2489d6af02a18e5cbba46ca54eac10528c))
* **l10n:** Update translations from Transifex ([caf2aab](https://github.com/nextcloud/contacts/commit/caf2aab1a36539e00bc13a13b0f0c2657d2ce8eb))
* **l10n:** Update translations from Transifex ([1df65a7](https://github.com/nextcloud/contacts/commit/1df65a758eeec94ad331185202daf3759734ed4b))
* **PropertyText:** textarea auto resizing ([7494f35](https://github.com/nextcloud/contacts/commit/7494f3552e3f1ab2b4895978f10e48d725988d59))
* routing based on base64 encoding ([7aa9980](https://github.com/nextcloud/contacts/commit/7aa9980c3e5ed83993fdc6ea521b57a648356c49))
* translation for recently contacted not working ([e8523b1](https://github.com/nextcloud/contacts/commit/e8523b1e73f978625aeef999633149e2f0160fe6))



# [7.3.0-rc.1](https://github.com/nextcloud/contacts/compare/v7.0.0-beta.2...v7.3.0-rc.1) (2025-08-22)
